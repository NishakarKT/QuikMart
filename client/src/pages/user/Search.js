...
const Search = () => {
  ...
  return (
    <Fragment>
      ...
      <Stack pt={9}>
        <Typography px={2} py={1} variant="h5" color="text.secondary">
        ...
        <Grid container>
          {filteredProducts.slice(ITEMS_PER_PAGE * (page - 1), ITEMS_PER_PAGE * page).map((product) => (
            <Grid item xs={12} sm={6} lg={3} p={1} key={product.img}>
